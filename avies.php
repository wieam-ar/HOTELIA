...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO feedback 
        (name, email, phone, satisfaction, liked_aspects, comments, improvements) 
        VALUES (?, ?, ?, ?, ?, ?, ?)");

    $stmt->execute([
        $name, $email, $phone, $satisfaction, $liked, $comments, $improvements
    ]);
...
<body>
    ...
    <div class="container" id="avies"   >
        ...
        <form mathod="post" id="feedbackForm">
